...
public class RemoteTransformations : MonoBehaviour
{
    ...
    void Start()
    {
        try
        {
            ...
            if (!zeroOut) initialWorldSpacePosition = (this.gameObject.transform.parent) ? this.gameObject.transform.parent.transform.position : this.gameObject.transform.position;
            else initialWorldSpacePosition = Vector3.zero;
    ...
    public void Update()
    {
        ...
        if (this.gameObject.transform.parent) {
            if (!zeroOut) initialWorldSpacePosition = this.gameObject.transform.parent.transform.position;
            else initialWorldSpacePosition = Vector3.zero;
        }
